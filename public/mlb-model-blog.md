...
At first I wanted something that I can use to beat Vegas, but a lot of knowledge was learned a lot the way that was more valuable than a few dollars.

---

I lost money betting on baseball.

Not a catastrophic amount compared to some of my degen friends, sometimes needing to pick up a few extra shifts to make up for it. I don't hate losing money. I hate losing money to *randomness I could have modeled*. So I did the thing every stats undergrad does when they get annoyed: I decided to build a model.
...
![The dashboard's slate view: a list of the day's games, each with a projected score, a projected total with a plus-or-minus, and a small distribution shape. Totals range from 7.4 for Brewers-Giants to 9.5 for Blue Jays-Nationals.](public/gameview.png)
...
![The deployed model's coefficients: intercept 1.29, log(offense) 1.14, starter 0.90, bullpen 1.21, park 0.81, home 0.002, dispersion k=3.53, trained on 14,544 team-games from 2023-25.](public/model.png)
...
*The code is at [https://github.com/dkyxhjj/mlb_predictor](https://github.com/dkyxhjj/mlb_predictor). The live dashboard is at [https://mlb-predictor.pages.dev/](https://mlb-predictor.pages.dev/). If you want to argue with me about whether the home-run term should really shrink that hard, email me at richardli.060411@gmail.com — I'd genuinely enjoy it.*
